...
public class CrashMain implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource() == InputPanel.launch){
            carPane.launch(Integer.parseInt(InputPanel.lanes.getText()), Integer.parseInt(InputPanel.lightDuration.getText())*1000, Integer.parseInt(InputPanel.trafficLevel.getText()));
